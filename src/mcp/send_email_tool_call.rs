...
use crate::{app::AppContext, models::SendEmailModel};
...
impl McpToolCall<SendEmailInputData, SendEmailToolResponse> for SendEmailToolHandler {
    async fn execute_tool_call(
        ...
        let result = crate::flows::send_email(&self.app, model.into()).await?;
...
impl From<SendEmailInputData> for SendEmailModel {
    fn from(src: SendEmailInputData) -> Self {
        Self {
